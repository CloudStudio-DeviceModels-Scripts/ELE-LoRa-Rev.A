...
# Parsing + Configuration Script – ELE-LoRa - Rev. A

This **Parsing + Configuration** script is designed for the **ELE-LoRa** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ELE-LoRa Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ELE-LoRa** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
